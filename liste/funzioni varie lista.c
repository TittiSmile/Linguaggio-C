...
int main ()
{
   ...
   /* printf("quale occorrenza vuoi contare?  ");
    ...
    stampa(l1);*/
     ...
     ///c'è qualcosa che non va. ho anche ricopiato la funzione dal programma es esame lug2016. lì funziona,qui no. non so perchè
...
void casuale()
{
    ...
    nodo*casuale(nodo*p,int dim)    se c'è void,non ritorna un cazzo! invece deve ritornare una lista con numeri casuali
    {
       int a;
       int i=0;
